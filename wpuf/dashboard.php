...
<style type="text/css">
td.fldedit a {text-decoration: none;}
</style>
    <h3 class="page-head">
        <!--<span class="colour"><?php printf( __( " Welcome %s", 'wp-user-frontend' ), $userdata->display_name ); ?></span>-->
		<span class="colour">My Pet Information</span>
    ...
    <?php if ( $dashboard_query->have_posts() ) {
        ...
        <div class="items-table-container">
            <table class="<?php echo implode( ' ', $post_type ); ?>" cellpadding="0" cellspacing="0">
                <thead>
                    <tr class="items-list-header">
                        ...
                        ?>
                        <!--<th><?php _e( 'ID', 'wp-user-frontend' ); ?></th> -->
                    ...
                    // populate meta column headers
                        ...
                        <!--<th><?php _e( 'Edit Pet Information', 'wp-user-frontend' ); ?></th>
                        <th><?php _e( 'Pet Information Form', 'wp-user-frontend' ); ?></th> -->
                    </tr>
                </thead>
                <tbody>
                    <?php
                            ...
                            <?php if( 'on' == $enable_payment && 'off' != $payment_column ): ?>
                                <td>
                                  ...
                                  <!-- View Pet Information  -->
                                     ...
                                     <?php } else { ?>
                                    |
                                     <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wp-user-frontend' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">View</a>
									...
									<!-- View Qrcode  -->
                                     ...
                                     | <a href="<?php the_permalink(); ?>?q=qrcode" title="<?php printf( esc_attr__( 'Permalink to %s', 'wp-user-frontend' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">View Membership Card and QR Code</a>
