<style>
div#pmpro_pricing_fields h3 span.pmpro_checkout-h3-name {font-weight: 600;padding-bottom: 15px;}
div#pmpro_level_cost p strong {font-weight: 400;}
p.member_class a {color: #334f7d;font-weight: 600;}
p.member_class a:hover {text-decoration: none;color: #000;}

div#pmpro_level_cost p strong {font-weight: 600;}
p.member_class {margin-top: -20px;}
.intro p:first-child {display: block !important;}
.pmhide.intro p {display: none;}
.intro #other_discount_code_p {display: none !important;}
@media (max-width: 768px) {
span.pmpro_checkout-h3-name.cktitle {font-size: 20px;} .pmpro_checkout-fields p {font-size: 16px;} }

.pmpro_checkout-h3-name {font-size: 21px; margin-bottom: 20px !important;}
.pmpro_checkout-fields {display: -ms-flexbox; display: flex; -ms-flex-wrap: wrap; flex-wrap: wrap; margin-right: -15px; margin-left: -15px;}
.pmpro_checkout-fields .pmpro_checkout-field {-ms-flex: 0 0 50%; flex: 0 0 50%; max-width: 50%; position: relative; width: 100%; padding-right: 15px; padding-left: 15px;}
.pmpro_checkout-fields .pmpro_checkout-field input, 
.pmpro_checkout-fields .pmpro_checkout-field select {color: #666; background: #FFF; border: 1px solid #ccc; margin: 0; padding: 6px 10px; width: 100%; }
...
.pmpro_checkout-fields .pmpro_checkout-field.pmpro_payment-cvv {-ms-flex: 0 0 100%; flex: 0 0 100%; max-width: 100%; }
.pmpro_checkout-fields .pmpro_checkout-field label {font-size: 16px; margin-bottom: 0px; }
.pmpro_btn-submit-checkout {background: #2e385c !important; color: #ffffff !important; border: 1px solid #2e385c !important; border-radius: 0px !important;}

@media (max-width: 1023px) {
	.pmpro_checkout-h3-name {font-size: 18px; margin-bottom: 10px !important;}
	.pmpro_checkout-fields .pmpro_checkout-field {-ms-flex: 0 0 100%; flex: 0 0 100%; max-width: 100%;}
	.pmpro_checkout-fields .pmpro_checkout-field label {font-size: 14px; margin-bottom: 0px;}
}


/** Checkout Page new styleing  **/
.hentry .vc_col-sm-6 {width: 100%; padding-left: 0; padding-right: 0;}
.pmpro_checkout-fields.ordersummary {display: -ms-flexbox; display: flex; -ms-flex-wrap: wrap; flex-wrap: wrap; margin-right: -15px; margin-left: -15px; }
.checkinfo {-ms-flex: 0 0 65%; flex: 0 0 65%; max-width: 65%; position: relative; width: 100%; padding-right: 15px; padding-left: 15px; }
.membercost {-ms-flex: 0 0 35%; flex: 0 0 35%; max-width: 35%; position: relative; width: 100%; padding-right: 15px; padding-left: 15px; }

#pmpro_form .pmpro_checkout h3 {margin: 0px;}
#pmpro_pricing_fields h3 span.pmpro_checkout-h3-name {margin: 0px !important; display: block;}
#pmpro_form .pmpro_checkout .checkinfo h3 {border-bottom: 1px solid #ccc; margin-bottom: 15px;}

.cartsummary {background: #2e385c; color: #fff; padding: 15px;}
.cartsummary ul {padding: 0; margin: 0; list-style-type: none;}
.cartsummary ul li {display: flex; justify-content: space-between; padding: 10px 0px;}
.cartsummary ul li .cartsummary-label {padding-right: 10px; font-weight: 100;}
.cartsummary ul li:last-child {border-top: 1px solid #fff; margin-top: 10px;}
form.pmpro_form .pmpro_checkout-fields .cartsummary ul li div {margin: 0px; padding: 0px;}
.cartsummary ul li .cartsummary-value {font-weight: 700;}

.pmpro_checkout.pmprocheck {-ms-flex: 0 0 65%; flex: 0 0 65%; max-width: 65%; position: relative; width: 100%; }
 @media (max-width: 1023px) {
 	.checkinfo {-ms-flex: 0 0 60%; flex: 0 0 60%; max-width: 60%;}
	.membercost {-ms-flex: 0 0 40%; flex: 0 0 40%; max-width: 40%;}
	.cartsummary ul li {padding: 5px 0px;}
	form.pmpro_form .pmpro_checkout-fields div, #loginform p {font-size: 14px;}

	.pmpro_checkout.pmprocheck {-ms-flex: 0 0 60%; flex: 0 0 60%; max-width: 60%;}
 }
  @media (max-width: 767px) {
 	.checkinfo {-ms-flex: 0 0 100%; flex: 0 0 100%; max-width: 100%;}
	.membercost {-ms-flex: 0 0 100%; flex: 0 0 100%; max-width: 100%;}
	.pmpro_checkout.pmprocheck {-ms-flex: 0 0 100%; flex: 0 0 100%; max-width: 100%;}
 }
.pmhide {padding-top: 16px;}
.dsbbtn {
    ...
    background-color: #2E385C!important;
...
<form id="pmpro_form" class="<?php echo pmpro_get_element_class( 'pmpro_form' ); ?>" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<?php
		...
		<div id="pmpro_pricing_fields" class="<?php echo pmpro_get_element_class( 'pmpro_checkout', 'pmpro_pricing_fields' ); ?>">
			...
			<div class="<?php echo pmpro_get_element_class( 'pmpro_checkout-fields' ); ?> ordersummary">
			 <div class="checkinfo">  
			 <h3>
				<span class="<?php echo pmpro_get_element_class( 'pmpro_checkout-h3-name cktitle' ); ?>"><?php _e('ICEpetcare', 'paid-memberships-pro' );?> <?php printf(__('%s Membership', 'paid-memberships-pro' ), $pmpro_level->name);?> </span>
				<?php if(count($pmpro_levels) > 1) { ?><span class="<?php echo pmpro_get_element_class( 'pmpro_checkout-h3-msg' ); ?>"><a href="<?php echo pmpro_url("levels"); ?>"><?php _e('Change membership', 'paid-memberships-pro' );?></a></span><?php } ?>
			</h3>
				<p>
					<?php //printf(__('You have selected the <strong>%s</strong> membership level.', 'paid-memberships-pro' ), $pmpro_level->name);?>
					<?php printf(__('This 1 year membership includes:', 'paid-memberships-pro' ), $pmpro_level->name);?>
				</p>
				...
				<div id="other_discount_code_tr">
					...
					<input type="button" class="btndiscount dsbbtn" name="other_discount_code_button" id="other_discount_code_button" value="<?php _e('Apply', 'paid-memberships-pro' );?>" />
				</div>
				    ...
				    <?php  $billamount = pmpro_escape_price( $pmpro_level->initial_payment );
				        $pmpro_level_id = $pmpro_level->id;  
				       $discount_level = $wpdb->get_var('SELECT initial_payment FROM wp_pmpro_membership_levels WHERE id = '.$pmpro_level_id);
            		  $tax = pmpro_getOption("tax_rate"); 
		              $ab = $tax*100;  $tax_rate = $discount_level*$ab/100; $pay_total =$tax_rate + $discount_level; ?>
					
					<div class="membercost">
					  <h3>
				     <span class="<?php echo pmpro_get_element_class( 'pmpro_checkout-h3-name cktitle' ); ?>"><?php _e('Order Summary', 'paid-memberships-pro' );?></span>
		            </h3>   
					<?php //echo wpautop(pmpro_getLevelCost($pmpro_level));  ?>
					<?php } ?>
					<div class="dsdisval" style="display:none;"></div>
					
					<div id="paytotds" style="display:none;"><?php echo $pay_total; ?></div>
					<div class="cartsummary">
					    <ul>
					        <li>
					            <div class="cartsummary-label">Membership Subtotal</div>
					            <div class="cartsummary-value" id="memsubid">$<?php echo number_format($discount_level, 2); ?></div>
					        </li>
					        <?php if ($tax == "") { ?>
					        
					        <li style="display:none;">
					            <div class="cartsummary-label">Sales Tax</div>
					            <div class="cartsummary-value" id="txtamount">$<?php echo $tax_rate; ?></div>
					        </li>
					        
					        <li id="dispart" style="display:none;">
					            <div class="cartsummary-label">Discount</div>
					            <div class="cartsummary-value" id="couponamt"></div>
					        </li>
					        <li>
					            <div class="cartsummary-label">Order Total</div>
					            <div class="cartsummary-value ord_tot_ds" >$<?php echo number_format($pay_total, 2); ?></div>
					        </li>
					       ...
					       <?php } else { ?> 
					        ...
					        <li>
					            <div class="cartsummary-label">Order Total</div>
					            <div class="cartsummary-value ord_tot_ds">$<?php echo $pay_total; ?></div>
					        </li>
					        <?php  } ?> 
					    </ul>
	...
	?>
	<div id="pmpro_user_fields" class="<?php echo pmpro_get_element_class( 'pmpro_checkout', 'pmpro_user_fields' ); ?> pmprocheck">
		<hr />
		<h3>
			<span class="<?php echo pmpro_get_element_class( 'pmpro_checkout-h3-name' ); ?>"><?php _e('Account Information', 'paid-memberships-pro' );?></span>
			<span class="<?php echo pmpro_get_element_class( 'pmpro_checkout-h3-msg' ); ?>"><?php _e('Already have an account?', 'paid-memberships-pro' );?> <a href="<?php echo home_url('/member-login'); ?>"><?php _e('Log in here', 'paid-memberships-pro' );?></a></span>
		</h3>
...
<p class="member_class">By signing up, you agree to ICEpetcare’s <br> <a href="<?php echo home_url('/terms-and-conditions'); ?>"> Terms & Conditions</a> and <a href="<?php echo home_url('/privacy-policy'); ?>"> Privacy Policy </a></p>
...
jQuery(document).ready(function(){
  jQuery(".btndiscount").click(function(){
    jQuery( document ).ajaxComplete(function(event,xhr,options) {
     jQuery(".pmhide").addClass("intro");   
    // Discount
    var disamt = jQuery('.dsdisval').text();      
    disamt=parseFloat(disamt).toFixed(2);
    
   
    
    if(disamt > 0){
          var txtamt = jQuery('#txtamount').text();
          txtamt = txtamt.replace("$", "");
          txtamt=parseFloat(txtamt).toFixed(2);
          //console.log("he->"+txtamt);
          var memsubid = jQuery('#memsubid').text();
          memsubid = memsubid.replace("$", "");
          memsubid=parseFloat(memsubid).toFixed(2);
           //console.log("he->"+memsubid);
        jQuery('#couponamt').text('- $'+disamt);
        
        // Order Total
        var gettot = jQuery('#paytotds').text();
        
        //gettot=parseFloat(gettot).toFixed(2); 

        var fntot = parseFloat(memsubid)+parseFloat(txtamt)-parseFloat(disamt);
        //console.log("he->"+fntot);
        fntot=fntot.toFixed(2);
        jQuery('.ord_tot_ds').html('$'+fntot);
        
        jQuery('#dispart').show();  
        }else{
        jQuery('.dsdisval').text('0'); 
