	...
	<div id="pmpro_account">
		...
		<?php if(in_array('profile', $sections)) { ?>
			...
			<div class="podbtn">
				...
				<a href="<?php echo home_url(); ?>/product/additional-products/" class="print_btn" id="printButton">Order Additional Products</a>  
		...
		<div id="pmpro_account-invoices" class="<?php echo pmpro_get_element_class( 'pmpro_box', 'pmpro_account-invoices' ); ?>">
			...
			<table class="<?php echo pmpro_get_element_class( 'pmpro_table' ); ?> mypod" width="100%" cellpadding="0" cellspacing="0" border="0">
				<thead>
					<tr>
